...
bear” and “doesn’t bear any fruit” starts off with the same embedding but after
several attention phases represents different points in the embedding space.
...
fraction of the compute required for the original training (\~5%).
...
model at [Appendix: Overview of Training](../training/), while the discussion
about inference and serving requests continues at
[Inference and the KV Cache](../kvcache/).
